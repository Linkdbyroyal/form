...
// TIJDELIJKE DEBUG-REGEL — laat zien of de key goed binnenkomt, zonder hem te tonen
const _k = process.env.ANTHROPIC_API_KEY || '';
console.log('DEBUG key aanwezig:', !!_k, '| lengte:', _k.length, '| eerste 12 tekens:', _k.slice(0,12), '| laatste 4 tekens:', _k.slice(-4));
